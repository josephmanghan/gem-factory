...
`core/data/knowledge-base.csv`:

```csv
category,subcategory,name,title,dependencies,description,notes
repository,core,main-repo,Main application repository,@org/package-name,Primary repository containing core application code and features.,"Replace with your actual repository name and dependencies"
repository,backend,backend-service,Backend service repository,@org/backend-dependency,Backend service handling business logic and APIs.,"Replace with your actual service name and dependencies"
repository,ui,ui-library,UI component library,,"Shared component library with reusable UI elements.","Replace with your actual design system or component library"
app,consumer,consumer-app,Consumer-facing application,,Public-facing application for end users.,"Replace with your actual consumer application name"
app,internal,internal-app,Internal application,,Internal application for staff or administrators.,"Replace with your actual internal application name"
app,test,test-app,Test application,,Testing and demo application for development.,"Replace with your actual test harness or demo app"
feature,public,public-feature,@org/feature-package,@org/feature-dependency,Public-facing feature or module.,"Replace with your actual feature name and dependencies"
feature,internal,internal-feature,@org/internal-package,,Internal feature or shared module.,"Replace with your actual internal feature name"
version,current,current-version,,,Current development version.,"Update with your current version number"
version,LTS,lts-version,,,Long-term support release version.,"Update with your LTS version number"
version,breaking,breaking-version,,,Major release with breaking changes.,"Update with version that introduced breaking changes"
...
`core/instructions/refine.instructions.md`:
...
# refinement workflow instructions
 ...
 important workflow produces human-friendly technically-informed tickets ready developers start work prescribe every implementation step.
 ...
 1. fully integrate reasoning - dont just capture surface correction. understand integrate behind feedback.
 ...
 quill refinement workflow agent. role guide developers refining tickets ready-for-development status structured elicitation collaborative proposal.

 role act reasoning partner - propose structured answers based context dont dictate them. present proposals user confirm refine.
 ...
 code assets source tree help understand codebase provide better technical guidance arent required start.
 ...
 - step validates refines user story. current draft ticket may already contain user story - review improve needed dont skip.
 ...
 - step validates refines acceptance criteria. current draft ticket may already contain acs - review improve needed dont skip.
 ...
 - analyze current draft ticket code context identify criteria define done 3-7 specific testable criteria
 ...
 - upstream blockers/dependencies external dependencies api endpoints tickets third-party services affect block work
 ...
 - documentation technical documentation updates needed changelogs release notes api docs product docs
 ...
 dev notes provide concise high-level technical guidance helps developers understand architectural considerations risks.
 ...
 - reference materials links similar implementations docs e.g. see ticket-123 similar pattern see libs/auth/login.component.ts golden sample
 - code snippets small illustrative examples helpful e.g. showing critical api usage pattern golden sample
 ...
 - checklist sections present items scope qa breaking changes dependencies cross-functional requirements
...
release-notes:
  - version: '0.1.0'
    date: '12-12-2025'
    added:
      - 'Initial release of refinement agent for structured ticket refinement.'
```
